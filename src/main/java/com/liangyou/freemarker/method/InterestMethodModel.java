 ...
 * 有四种方式:
　　(1).在模板文件中注册,在模板中使用
　　<#assign interest= "com.rongdu.freemarker.InterestMethodModel"?new()>
...
　  (2).处理模板文件时注册
	...
	(3).Struts2集成处理,自定义FreemarkerManager
        ...
        configuration.setSharedVariable("interest", new InterestMethodModel() );  
	     2、struts2.xml配置文件新增
	      <constant name="struts.freemarker.manager.classname"  value="com.rongdu.freemarker.CustomFreemarkerManager" />  
...
public class InterestMethodModel implements TemplateMethodModel {
	private static Logger logger = Logger.getLogger(InterestMethodModel.class);
