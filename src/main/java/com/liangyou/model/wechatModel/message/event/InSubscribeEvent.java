 ...
 */
public class InSubscribeEvent extends InEventMsg
{	
	
    public InSubscribeEvent() {
		super();
	}
    ...
    public InSubscribeEvent(String toUserName, String fromUserName, Long createTime, String msgType, String event)
    {
	...
	public String toString() {
		return "InSubscribeEvent [event=" + event + ", toUserName=" + toUserName + ", fromUserName=" + fromUserName
