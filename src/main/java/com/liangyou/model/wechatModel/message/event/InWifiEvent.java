 ...
 */
public class InWifiEvent extends InEventMsg
{
    ...
    public InWifiEvent(String toUserName, String fromUserName, Long createTime, String msgType, String event)
    {
	...
	public String toString() {
		return "InWifiEvent [connectTime=" + connectTime + ", expireTime=" + expireTime + ", vendorId=" + vendorId
				+ ", shopId=" + shopId + ", deviceNo=" + deviceNo + ", event=" + event + ", toUserName=" + toUserName
