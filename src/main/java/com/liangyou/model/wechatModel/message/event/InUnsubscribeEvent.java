 ...
 */
public class InUnsubscribeEvent extends InEventMsg
{	
	
    public InUnsubscribeEvent() {
		super();
	}
    ...
    public InUnsubscribeEvent(String toUserName, String fromUserName, Long createTime, String msgType, String event)
    {
	...
	public String toString() {
		return "InUnsubscribeEvent [event=" + event + ", toUserName=" + toUserName + ", fromUserName=" + fromUserName
