...
public class InVideoMsg extends InMsg {
	...
	public InVideoMsg(String toUserName, String fromUserName, Long createTime, String msgType) {
	...
	public String toString() {
		return "InVideoMsg [mediaId=" + mediaId + ", thumbMediaId=" + thumbMediaId + ", msgId=" + msgId
