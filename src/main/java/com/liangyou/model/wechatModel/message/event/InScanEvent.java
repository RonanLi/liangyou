...
public class InScanEvent extends InEventMsg {
	...
	public InScanEvent(String toUserName, String fromUserName, Long createTime, String msgType, String event) {
	...
	public String toString() {
		return "InScanEvent [eventKey=" + eventKey + ", ticket=" + ticket + ", event=" + event + ", toUserName="
