...
public class InShakearoundUserShakeEvent extends InMsg {
	...
	public InShakearoundUserShakeEvent(String toUserName, String fromUserName, Long createTime, String msgType) {
	...
	public String toString() {
		return "InShakearoundUserShakeEvent [event=" + event + ", uuid=" + uuid + ", major=" + major + ", minor="
				+ minor + ", distance=" + distance + ", aroundBeaconList=" + aroundBeaconList + ", toUserName="
