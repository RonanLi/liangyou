 ...
 */
public class InTemplateMsgEvent extends InEventMsg {
	...
	public InTemplateMsgEvent(String toUserName, String fromUserName, Long createTime, String msgType, String event) {
	...
	public String toString() {
		return "InTemplateMsgEvent [msgId=" + msgId + ", status=" + status + ", event=" + event + ", toUserName="
