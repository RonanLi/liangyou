 ...
 */
public class InCustomEvent extends InEventMsg
{
    ...
    public InCustomEvent(String toUserName, String fromUserName, Long createTime, String msgType, String event)
    {
	...
	public String toString() {
		return "InCustomEvent [kfAccount=" + kfAccount + ", toKfAccount=" + toKfAccount + ", event=" + event
