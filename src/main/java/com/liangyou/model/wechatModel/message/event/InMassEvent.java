...
public class InMassEvent extends InEventMsg
{
    ...
    public InMassEvent(String toUserName, String fromUserName, Long createTime, String msgType, String event)
    {
	...
	public String toString() {
		return "InMassEvent [msgId=" + msgId + ", status=" + status + ", totalCount=" + totalCount + ", filterCount="
				+ filterCount + ", sentCount=" + sentCount + ", errorCount=" + errorCount + ", event=" + event
