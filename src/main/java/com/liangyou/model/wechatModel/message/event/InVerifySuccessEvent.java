...
public class InVerifySuccessEvent extends InEventMsg
{
    ...
    public InVerifySuccessEvent(String toUserName, String fromUserName, Long createTime, String msgType, String event)
    {
	...
	public String toString() {
		return "InVerifySuccessEvent [expiredTime=" + expiredTime + ", event=" + event + ", toUserName=" + toUserName
