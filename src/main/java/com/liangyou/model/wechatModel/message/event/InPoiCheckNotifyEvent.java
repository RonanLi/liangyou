 ...
 * </xml>
 */
public class InPoiCheckNotifyEvent extends InEventMsg
{
...
//	Msg 成功的通知信息,或审核失败的驳回理由
    ...
    public InPoiCheckNotifyEvent(String toUserName, String fromUserName, Long createTime, String msgType, String event)
    {
	...
	public String toString() {
		return "InPoiCheckNotifyEvent [uniqId=" + uniqId + ", poiId=" + poiId + ", result=" + result + ", msg=" + msg
