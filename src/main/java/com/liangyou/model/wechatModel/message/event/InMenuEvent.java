...
public class InMenuEvent extends InEventMsg {
	...
	public InMenuEvent(String toUserName, String fromUserName, Long createTime, String msgType,String event) {
	...
	public String toString() {
		return "InMenuEvent [eventKey=" + eventKey + ", scanCodeInfo=" + scanCodeInfo + ", event=" + event
