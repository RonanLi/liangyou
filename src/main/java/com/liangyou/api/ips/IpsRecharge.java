...
public class IpsRecharge extends IpsModel {
	...
	public IpsRecharge doRechargeCreate(String str){
		IpsRecharge ipsRe = new IpsRecharge();
		XmlTool1 tool = new XmlTool1();
		tool.SetDocument(str);
		ipsRe.setMerBillNo(tool.getNodeValue("pMerBillNo"));
		ipsRe.setAcctType(tool.getNodeValue("pAcctType"));
		ipsRe.setIdentNo(tool.getNodeValue("pIdentNo"));
		ipsRe.setRealName(tool.getNodeValue("pRealName"));
		ipsRe.setIpsAcctNo(tool.getNodeValue("pIpsAcctNo"));
		ipsRe.setTrdDate(tool.getNodeValue("pTrdDate"));
		ipsRe.setTrdAmt(tool.getNodeValue("pTrdAmt"));
		ipsRe.setTrdBnkCode(tool.getNodeValue("pTrdBnkCode"));
		ipsRe.setIpsBillNo(tool.getNodeValue("pIpsBillNo"));
		ipsRe.setMemo1(tool.getNodeValue("pMemo1"));
		ipsRe.setMemo2(tool.getNodeValue("pMemo2"));
		ipsRe.setMemo3(tool.getNodeValue("pMemo3"));
		return ipsRe;
	}
