 ...
 *
 */
public class CashReconciliation extends ChinapnrModel {
	private String beginDate;
	private String endDate;
	private String pageNum;
	private String pageSize;
	private String cashReconciliationDtoList;  //取现对账信息字符串
	public CashReconciliation(String beginDate,String endDate,String pageNum,String pageSize){
		super();
	...
	public ChinapnrModel response(String res) throws IOException {
		...
		//	this.setCashReconciliationDtoList(json.getString("CashReconciliationDtoList"));
		} catch (Exception e) {
