...
public class InitiativeTender extends ChinapnrModel {
	private static final Logger logger=Logger.getLogger(InitiativeTender.class);
	   /**
	    * 用户主动投标
	    *  借款人信息使用json传输
	    ...
	    * */
		...
		public InitiativeTender(String usrCustId,String transAmt,String maxTenderRate){
			super();
			...
			this.setRetUrl(Global.getValue("weburl")+"/public/chinapnr/autoTenderReturn.html");
