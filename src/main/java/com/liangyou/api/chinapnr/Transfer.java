...
public class Transfer extends ChinapnrModel {
	/**
	...
	public Transfer(String transAmt, String inCustId, String ordId,
			String outAcctId, String inAcctId) {
		super();
		this.setCmdId("Transfer");
		if (StringUtils.isBlank(inAcctId) || StringUtils.isBlank(outAcctId)) {//线下充值
			this.isWeb = true;
			this.setOutAcctId(Global.getValue("merAcctId"));
