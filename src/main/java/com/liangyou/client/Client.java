...
public class Client extends PHPFunctions{
	...
	public static String UC_IP = "42.121.88.194";
	public static String UC_API = "http://bbs.daishuba.com/uc_server";
	public static String UC_CONNECT = "";
	public static String UC_KEY = "oaRdH5p2fd6aC8W815P2g0NaD7Z5w1jau21dB66eTes9dfyaG03cx2EaD6a7Ca76";
