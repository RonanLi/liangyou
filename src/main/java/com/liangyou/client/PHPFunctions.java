...
import com.liangyou.util.Base64;
/**
 * ================================================
...
public abstract class PHPFunctions {
	//JAVA EXTRA METHOD
	private static Logger logger = Logger.getLogger(PHPFunctions.class);
	...
	protected String base64_decode(String input){
		try {
			return new String(com.liangyou.util.Base64.decode(input.toCharArray()),"iso-8859-1");
		} catch (Exception e) {
			return e.getMessage();
		}
	}
