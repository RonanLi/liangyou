...
//---------------------------------------------------【左边栏导航】
$(function(){
    $('.nav-visitors-item h1').click(function(){
...
function alertDialog(titlestr,contentStr){
	$.dialog({title:titlestr,content:'url:'+contentStr,lock:true});
}
...
function alertFixedDialog(titlestr,contentStr,widthStr, heightStr){
	$.dialog({title:titlestr,content:'url:'+contentStr,lock:true,width: widthStr+"px",height: heightStr+"px"});
}
